...
local function get_task_find_destination()
  ...
  return task_find_destination
end


local function get_task_reach_destination_forward()
  ...
  return task_reach_destination_forward
end

local function get_task_reach_destination_reverse()
...
function TruckAi.init(self, truck, waypoints)
    if not truck.ai_data then
        ...
        truck.ai_data.behaviour_tree = get_truck_tree()
